...
if __name__ == "__main__": 
    ...
    train_bd = pd.read_pickle("data_descriptors/train_coilDB_descriptors.pkl")
    
    # load train dataset
    train_set_img = pd.read_pickle("data/coil-100/train_set.pkl")
    
    list_labels =  np.loadtxt('data/coil-100/labels.txt', dtype=np.str)
